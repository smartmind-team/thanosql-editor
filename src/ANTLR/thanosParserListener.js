...
// This class defines a complete listener for a parse tree produced by thanosParser.
export default class thanosParserListener extends antlr4.tree.ParseTreeListener {
  // Enter a parse tree produced by thanosParser#thanosLanguage.
  enterThanosLanguage(ctx) {}

  // Exit a parse tree produced by thanosParser#thanosLanguage.
  exitThanosLanguage(ctx) {}

  // Enter a parse tree produced by thanosParser#thanosQuery.
  enterThanosQuery(ctx) {}
