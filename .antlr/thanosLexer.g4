...
//#############################//
//### THANOSQL MODEL CLAUSE ###//
//#############################//
MODEL : [Mm][Oo][Dd][Ee][Ll];
BUILD : [Bb][Uu][Ii][Ll][Dd];
FIT : [Ff][Ii][Tt];
UPLOAD : [Uu][Pp][Ll][Oo][Aa][Dd];
...
//###############################//
//### THANOSQL CONVERT CLAUSE ###//
//###############################//
CONVERT : [Cc][Oo][Nn][Vv][Ee][Rr][Tt];

//##############################//
//### THANOSQL SEARCH CLAUSE ###//
//##############################//
SEARCH : [Ss][Ee][Aa][Rr][Cc][Hh];

//################################//
//### THANOSQL FUNCTION CLAUSE ###//
//################################//
FUNCTION : [Ff][Uu][Nn][Cc][Tt][Ii][Oo][Nn];

//#############################//
//### THANOSQL PRINT CLAUSE ###//
//#############################//
PRINT : [Pp][Rr][Ii][Nn][Tt];

//############################//
//### THANOSQL COPY CLAUSE ###//
//############################//
COPY : [Cc][Oo][Pp][Yy];

//############################//
//### THANOSQL LIST CLAUSE ###//
//############################//
LIST : [Ll][Ii][Ss][Tt];
TABLE : [Tt][Aa][Bb][Ll][Ee];
THANOSQL : [Tt][Hh][Aa][Nn][Oo][Ss][Qq][Ll];
...
// python name rule for compatibility
