// Generated from ./.antlr/PostgreSQLParser.g4 by ANTLR 4.13.1
// jshint ignore: start
...
export default class PostgreSQLParserVisitor extends antlr4.tree.ParseTreeVisitor {
  ...
  visitOpttypedtableelementlist(ctx) {
    return this.visitChildren(ctx);
  }
  ...
  visitTypedtableelementlist(ctx) {
    return this.visitChildren(ctx);
  }
  ...
  visitTable_access_method_clause(ctx) {
    return this.visitChildren(ctx);
  }
  ...
  visitForeign_server_version(ctx) {
    return this.visitChildren(ctx);
  }
  ...
  visitIndex_including_params(ctx) {
    return this.visitChildren(ctx);
  }
  ...
  visitFunc_arg_with_default(ctx) {
    return this.visitChildren(ctx);
  }
